 ...
 * @author proto
 */
public class JDlgRhgCompras extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JDlgRhgCompras.class.getName());

    /**
     * Creates new form JDlgRhgCompras
     * @param parent
     * @param modal
     */
    public JDlgRhgCompras(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            JDlgRhgCompras dialog = new JDlgRhgCompras(new javax.swing.JFrame(), true);
